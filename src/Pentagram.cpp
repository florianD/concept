...
namespace rpg
{
    SDL_Rect Pentagram::d_spriteClips[8];
    Image Pentagram::d_spriteSheetTexture;

    Pentagram::Pentagram():d_frame(0), d_offset(0), d_clip(0){}

    bool Pentagram::loadSpriteSheet(SDL_Renderer *renderer, std::string path)
    {
        bool success = true;
    ...
    int Pentagram::getHeight() const
    {
        return d_spriteSheetTexture.getHeight();
    }

    int Pentagram::getWidth() const
    {
